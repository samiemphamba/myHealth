...
public class Tools {
    ...
    public static int getFieldPosition(String field, ArrayList header) {
    ...
    public static String getInitial(String text) {
        if (text.trim().equals(""))
            return "";
        String t = text.charAt(0) + "";
        return t.trim().toUpperCase();
    }

    public static TextDrawable getDrawable(String text, Context ctx) {
        TextDrawable drawable = TextDrawable.builder()
                .beginConfig()
                .width(70)
                .height(70)
                .endConfig()
                .buildRound(text, MaterialColor.getColor(ctx));
        return drawable;
    }
...
//        13-08-2020
    ...
    public static String getTime(String tstamp) {
        String[] arr = tstamp.split(" ");
        if (arr.length > 0)
            return arr[1];
        return arr[0];
    }
...
//                    .placeholder(ctx.getResources().getDrawable(R.drawable.loading))
//                    .error(ctx.getResources().getDrawable(R.drawable.ic_mlw_logo_svg))
//                    .into(img);
//        } catch (Exception e) {
//        }
//    }
//
//    public static void displayImageRoundFromDrawable(final Context ctx, final ImageView img, @DrawableRes int drawable) {
//        try {
//            Glide.with(ctx)
//                    .load(drawable)
//                    .placeholder(ctx.getResources().getDrawable(R.drawable.loading))
//                    .error(ctx.getResources().getDrawable(R.drawable.ic_default))
//                    .into(img);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
//
//    public static void displayImageRound(final Context ctx, ImageView img, String image, int w, int h, boolean cacheable) {
//        try {
//            String url = Global.SERVER_ADDRESS + "API/mOBS/images/" + image + ".png";
//            if (cacheable)
